...
const payment_method_info = { 
    title: <>All Asset <br />type distribution</>,
    desctiption: <>Explore a wide range of asset trading categories</>,
...
const PaymentMethodArea = () => {
    return (
      <>
        <div className="tp-payment-method__area tp-payment-method__space pt-50">
